...
def choisir4 ():
   ...
   reserver4 = Tk()
   reserver4.title('Choisir ma place')
   reserver4.iconbitmap(r'icone.ico')
   #---------------------------------------------------
   l1=Label(reserver4,text="Selectionnez vos places")
   l1.grid(row=0,column=0)

   l2=Label(reserver4,text="Salle 1  -  27 places")
   ...
   b1=Button(reserver4,text="Annuler",width=15, height=1,command=findevie)
   b1.grid(row=5,column=0)

   '''b2=Button(reserver4,text="stats",width=15, height=1,command=stats)
   b2.grid(row=3,column=0)'''

   p1=Button(reserver4,text="P1",command=info_1,bg='yellow')
   p1.grid(row=2,column=1)

   p2=Button(reserver4,text="P2",command=info_2,bg='yellow')
   p2.grid(row=2,column=2)

   p3=Button(reserver4,text="P3",command=info_3,bg='yellow')
   p3.grid(row=2,column=3)

   p4=Button(reserver4,text="P4",command=info_4,bg='yellow')
   p4.grid(row=2,column=4)

   p5=Button(reserver4,text="P5",command=info_5,bg='yellow')
   p5.grid(row=2,column=5)

   p6=Button(reserver4,text="P6",command=info_6,bg='yellow')
   p6.grid(row=2,column=6)

   p7=Button(reserver4,text="P7",command=info_7,bg='yellow')
   p7.grid(row=2,column=7)

   p8=Button(reserver4,text="P8",command=info_8,bg='yellow')
   p8.grid(row=2,column=8)

   p9=Button(reserver4,text="P9",command=info_9,bg='yellow')
   p9.grid(row=2,column=9)

   p10=Button(reserver4,text="P10",command=info_10,bg='yellow')
   p10.grid(row=3,column=1)

   p11=Button(reserver4,text="P11",command=info_11,bg='yellow')
   p11.grid(row=3,column=2)

   p12=Button(reserver4,text="P12",command=info_12,bg='yellow')
   p12.grid(row=3,column=3)

   p13=Button(reserver4,text="P13",command=info_13,bg='yellow')
   p13.grid(row=3,column=4)
            
   p14=Button(reserver4,text="P14",command=info_14,bg='yellow')
   p14.grid(row=3,column=5)

   p15=Button(reserver4,text="P15",command=info_15,bg='yellow')
   p15.grid(row=3,column=6)

   p16=Button(reserver4,text="P16",command=info_16,bg='yellow')
   p16.grid(row=3,column=7)

   p17=Button(reserver4,text="P17",command=info_17,bg='yellow')
   p17.grid(row=3,column=8)

   p18=Button(reserver4,text="P18",command=info_18,bg='yellow')
   p18.grid(row=3,column=9)

   p19=Button(reserver4,text="P19",command=info_19,bg='yellow')
   p19.grid(row=4,column=1)

   p20=Button(reserver4,text="P20",command=info_20,bg='yellow')
   p20.grid(row=4,column=2)

   p21=Button(reserver4,text="P21",command=info_21,bg='yellow')
   p21.grid(row=4,column=3)

   p22=Button(reserver4,text="P22",command=info_22,bg='yellow')
   p22.grid(row=4,column=4)

   p23=Button(reserver4,text="P23",command=info_23,bg='yellow')
   p23.grid(row=4,column=5)

   p24=Button(reserver4,text="P24",command=info_24,bg='yellow')
   p24.grid(row=4,column=6)

   p25=Button(reserver4,text="P25",command=info_25,bg='yellow')
   p25.grid(row=4,column=7)

   p26=Button(reserver4,text="P26",command=info_26,bg='yellow')
   p26.grid(row=4,column=8)

   p27=Button(reserver4,text="P27",command=info_27,bg='yellow')
